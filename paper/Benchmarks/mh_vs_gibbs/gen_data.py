...
def main():
    ...
    for L in [5, 10, 15, 20, 25, 30, 50]:
        ...
        for gain in [0.1, 1, 10, 100]:
            data[str(L)][str(gain)] = {}
            data[str(L)][str(gain)]["mh"] = {}
            data[str(L)][str(gain)]["mh"]["actime"] = []
            data[str(L)][str(gain)]["gibbs"] = {}
            data[str(L)][str(gain)]["gibbs"]["actime"] = []
            ...
            for trial in range(10):
                ...
                data[str(L)][str(gain)]["gibbs"]["actime"] += [gibbs_autocorr_time]
                data[str(L)][str(gain)]["mh"]["actime"] += [mh_autocorr_time]
